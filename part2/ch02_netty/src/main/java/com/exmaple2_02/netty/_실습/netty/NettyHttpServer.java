            ...
            var server = serverBootstrap
                    ...
                    .childHandler(new ChannelInitializer<>() {
                        ...
                        protected void initChannel(Channel ch) throws Exception {
                            ...
                            ch.pipeline().addLast(
                                    // HttpMessage, HttpContents
                                    new HttpServerCodec(), // http를 분석해서 socket에 있는 header 등의 정보를 모두 읽어서 http 객체들로 만든다.
                                    // HttpMessage, HttpContents 를 합쳐주는 클래스를 사용
                                    // FullHttpRequest 로 만들어준다.
